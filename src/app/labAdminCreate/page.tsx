...
//   }
// // lg:h-[calc(110vh-112px)]
//   return (
//     <Home>
//       <div
//         className="w-full flex  items-start justify-center h-[calc(100vh-80px)] sm:h-[calc(100vh-90px)]  md:h-[calc(100vh-100px)] lg:h-[calc(100vh-139px)] relative"
